...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Thread'
        db.create_table(u'msgs2_thread', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(related_name='threads', to=orm['msgs2.Account'])),
            ('thread_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
        ))
        db.send_create_signal(u'msgs2', ['Thread'])

        # Adding field 'Message.thread'
        db.add_column(u'msgs2_message', 'thread',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages', null=True, to=orm['msgs2.Thread']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Thread'
        db.delete_table(u'msgs2_thread')

        # Deleting field 'Message.thread'
        db.delete_column(u'msgs2_message', 'thread_id')
    ...
    models = {
        ...
        u'msgs2.message': {
            ...
            'thread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'messages'", 'null': 'True', 'to': u"orm['msgs2.Thread']"}),
        ...
        u'msgs2.thread': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'threads'", 'to': u"orm['msgs2.Account']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'thread_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'})
        },
        u'msgs2.todo': {
            'Meta': {'object_name': 'ToDo'},
            'date_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 12, 8, 0, 0)'}),
            'date_due': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 12, 9, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
