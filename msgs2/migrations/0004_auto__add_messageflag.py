...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'msgs2_messageflag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flags', to=orm['msgs2.Message'])),
            ('flag', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'msgs2', ['MessageFlag'])


    def backwards(self, orm):
        # Deleting model 'MessageFlag'
        db.delete_table(u'msgs2_messageflag')
