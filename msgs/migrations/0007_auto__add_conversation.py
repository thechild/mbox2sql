...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'msgs_conversation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='started_conversations', to=orm['msgs.Address'])),
            ('subject', self.gf('django.db.models.fields.TextField')()),
            ('initial_message', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['msgs.Message'])),
        ))
        db.send_create_signal(u'msgs', ['Conversation'])

        # Adding M2M table for field members on 'Conversation'
        m2m_table_name = db.shorten_name(u'msgs_conversation_members')
        ...
        db.create_unique(m2m_table_name, ['conversation_id', 'address_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'msgs_conversation')

        # Removing M2M table for field members on 'Conversation'
        db.delete_table(db.shorten_name(u'msgs_conversation_members'))
    ...
    models = {
        ...
        u'msgs.conversation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initial_message': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['msgs.Message']"}),
        ...
        u'msgs.message': {
            ...
            'conversations': ('django.db.models.fields.related.ManyToManyField', [], {'default': 'None', 'related_name': "'messages'", 'blank': 'True', 'symmetrical': 'False', 'to': u"orm['msgs.Conversation']"}),
