...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conversation.latest_message_date'
        db.add_column(u'msgs_conversation', 'latest_message_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1980, 1, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conversation.latest_message_date'
        db.delete_column(u'msgs_conversation', 'latest_message_date')
