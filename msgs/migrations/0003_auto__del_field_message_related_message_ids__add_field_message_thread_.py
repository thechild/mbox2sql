...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Message.related_message_ids'
        db.delete_column(u'msgs_message', 'related_message_ids')

        # Adding field 'Message.thread_index'
        db.add_column(u'msgs_message', 'thread_index',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Message.related_message_ids'
        db.add_column(u'msgs_message', 'related_message_ids',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Message.thread_index'
        db.delete_column(u'msgs_message', 'thread_index')
