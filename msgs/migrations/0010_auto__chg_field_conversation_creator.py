...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Conversation.creator'
        db.alter_column(u'msgs_conversation', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['msgs.Address']))

    def backwards(self, orm):

        # Changing field 'Conversation.creator'
        db.alter_column(u'msgs_conversation', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['msgs.Address']))
