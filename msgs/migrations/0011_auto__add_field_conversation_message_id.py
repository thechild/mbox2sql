...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conversation.message_id'
        db.add_column(u'msgs_conversation', 'message_id',
                      self.gf('django.db.models.fields.CharField')(default='DEFAULT', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conversation.message_id'
        db.delete_column(u'msgs_conversation', 'message_id')
