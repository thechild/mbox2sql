...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Conversation.thread_id'
        db.add_column(u'msgs_conversation', 'thread_id',
                      self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Conversation.thread_id'
        db.delete_column(u'msgs_conversation', 'thread_id')
    ...
    models = {
        ...
        u'msgs.conversation': {
            ...
            'thread_id': ('django.db.models.fields.CharField', [], {'max_length': '200', 'unique': 'True', 'null': 'True'})
        },
        u'msgs.header': {
