...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Conversation.initial_message'
        db.delete_column(u'msgs_conversation', 'initial_message_id')


    def backwards(self, orm):
        # Adding field 'Conversation.initial_message'
        db.add_column(u'msgs_conversation', 'initial_message',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['msgs.Message']),
                      keep_default=False)
