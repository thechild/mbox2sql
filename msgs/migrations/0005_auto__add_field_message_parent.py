...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'msgs_message', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='children', null=True, blank=True, to=orm['msgs.Message']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.parent'
        db.delete_column(u'msgs_message', 'parent_id')
